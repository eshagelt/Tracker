...
final class NewTrackerViewController: UIViewController {
    ...
    private let createButton = CustomButton(type: .system)
    ...
    @objc func addButtonTapped() {
        ...
        guard let rootVC = window?.rootViewController as? UITabBarController,
              ...
              let presentingVC = navVC.viewControllers.first as? TrackersViewController else { return }
...
extension NewTrackerViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if indexPath.row == 0 {
            ...
            let subtitleString = NSMutableAttributedString(string: subtitleText, attributes: [.font: UIFont.systemFont(ofSize: 16), .foregroundColor: UIColor.gray])
